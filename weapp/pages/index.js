...
_core["default"].page({
  ...
  methods: {
    ...
    changePageToLearning: function changePageToLearning() {
      console.log('changing to pageLearning');
      this.$navigate({
        url: 'pageLearning'
      });
    }
...
}, {info: {"components":{"list":{"path":"..\\components\\wepy-list"},"group":{"path":"..\\components\\group"},"panel":{"path":"..\\components\\panel"},"counter":{"path":"..\\components\\counter"},"slide-view":{"path":"..\\$vendor\\miniprogram-slide-view\\miniprogram_dist\\index"}},"on":{"7-71":["index-emit"]}}, handlers: {'7-63': {"tap": function proxy () {
  ...
  }},'7-64': {"tap": function proxy () {
    var $event = arguments[arguments.length - 1];
    var _vm=this;
      return (function () {
        _vm.changePageToLearning($event)
      })();
    
  }},'7-65': {"tap": function proxy () {
  ...
  }},'7-71': {"index-emit": function proxy () {
    var $event = arguments[arguments.length - 1];
    var _vm=this;
      return (function () {
